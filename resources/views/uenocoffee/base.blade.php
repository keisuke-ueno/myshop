...
<html lang="en">
    ...
    <body>
        <h1 class="site-heading text-center text-black-50 d-none d-lg-block">
            <img class="site-heading-upper img-fluid mb-6 mb-lg-6 rounded" src="assets/cup_yellow.jpg" alt="..." />
            <div class="site-heading-lower">UENO COFFEE FACTORY</divs>
        </h1>
        <!-- Navigation-->
        ...
        <section class="page-section clearfix">
            <div class="container">
                <div class="intro">
                    <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" src="assets/intro.jpg" alt="..." />
